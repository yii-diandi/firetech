...
class m210224_172529_diandi_bloc_conf_baidu extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%diandi_bloc_conf_baidu}}', [
            ...
            'API_KEY' => "varchar(100) NOT NULL DEFAULT '0' COMMENT 'API_KEY'",
            'SECRET_KEY' => "varchar(100) NOT NULL DEFAULT '0' COMMENT 'SECRET_KEY'",
