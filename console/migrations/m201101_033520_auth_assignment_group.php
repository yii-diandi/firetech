...
class m201101_033520_auth_assignment_group extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 外键约束设置 */
        $this->addForeignKey('fk_auth_user_group_5443_00','{{%auth_assignment_group}}', 'item_name', '{{%auth_user_group}}', 'name', 'CASCADE', 'CASCADE' );
