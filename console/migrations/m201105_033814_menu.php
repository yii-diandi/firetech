...
class m201105_033814_menu extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%menu}}',['id'=>'302','name'=>'店滴分销','parent'=>NULL,'route'=>'/diandi_distribution/default/index','order'=>'1','data'=>NULL,'type'=>'plugins','icon'=>NULL,'is_sys'=>'addons','module_name'=>'diandi_distribution']);
        ...
        $this->insert('{{%menu}}',['id'=>'306','name'=>'首页','parent'=>NULL,'route'=>NULL,'order'=>'1','data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        $this->insert('{{%menu}}',['id'=>'307','name'=>'价格配置','parent'=>'505','route'=>'/diandi_distribution/conf/price-conf/index','order'=>NULL,'data'=>NULL,'type'=>'plugins','icon'=>'fa fa-fw fa-jpy','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        $this->insert('{{%menu}}',['id'=>'308','name'=>'团队管理','parent'=>'502','route'=>'/diandi_distribution/level/member-level/index','order'=>NULL,'data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        $this->insert('{{%menu}}',['id'=>'309','name'=>'分销商等级','parent'=>'505','route'=>'/diandi_distribution/level/level/index','order'=>NULL,'data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        $this->insert('{{%menu}}',['id'=>'310','name'=>'商品','parent'=>NULL,'route'=>NULL,'order'=>'2','data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        ...
        $this->insert('{{%menu}}',['id'=>'341','name'=>'首页','parent'=>'306','route'=>'/diandi_distribution/default/index','order'=>'1','data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        $this->insert('{{%menu}}',['id'=>'342','name'=>'首页广告位','parent'=>'501','route'=>'/diandi_distribution/goods/location/index','order'=>NULL,'data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        ...
        $this->insert('{{%menu}}',['id'=>'344','name'=>'幻灯片','parent'=>'306','route'=>'/diandi_distribution/conf/slide/index','order'=>'1','data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        ...
        $this->insert('{{%menu}}',['id'=>'495','name'=>'库存管理','parent'=>'310','route'=>NULL,'order'=>NULL,'data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        $this->insert('{{%menu}}',['id'=>'496','name'=>'库存管理','parent'=>'495','route'=>'/diandi_distribution/goods/goods/index','order'=>NULL,'data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        $this->insert('{{%menu}}',['id'=>'497','name'=>'分类管理','parent'=>'495','route'=>'/diandi_distribution/goods/dd-category/index','order'=>NULL,'data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        $this->insert('{{%menu}}',['id'=>'498','name'=>'订单管理','parent'=>NULL,'route'=>NULL,'order'=>'3','data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        $this->insert('{{%menu}}',['id'=>'499','name'=>'订单管理','parent'=>'498','route'=>'/diandi_distribution/order/dd-order/index','order'=>NULL,'data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        $this->insert('{{%menu}}',['id'=>'500','name'=>'评论管理','parent'=>'498','route'=>'/diandi_distribution/setting/comment/index','order'=>NULL,'data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        $this->insert('{{%menu}}',['id'=>'501','name'=>'广告位','parent'=>'306','route'=>NULL,'order'=>'2','data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        $this->insert('{{%menu}}',['id'=>'502','name'=>'分销','parent'=>NULL,'route'=>NULL,'order'=>'4','data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        $this->insert('{{%menu}}',['id'=>'503','name'=>'配送点管理','parent'=>'498','route'=>'/diandi_distribution/setting/area/index','order'=>NULL,'data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        $this->insert('{{%menu}}',['id'=>'504','name'=>'商品标签','parent'=>'495','route'=>'/diandi_distribution/goods/label/index','order'=>NULL,'data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        $this->insert('{{%menu}}',['id'=>'505','name'=>'配置','parent'=>'502','route'=>NULL,'order'=>NULL,'data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
