...
class m210326_024755_auth_assignment_group extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%auth_assignment_group}}',['group_id'=>'567','item_name'=>'财务管理','user_id'=>'23','created_at'=>'1616639339']);
