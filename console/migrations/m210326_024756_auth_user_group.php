...
class m210326_024756_auth_user_group extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%auth_user_group}}',['id'=>'566','name'=>'商户管理员','type'=>'1','description'=>'','module_name'=>'diandi_distribution','created_at'=>'1607529526','updated_at'=>'1607529526']);
        $this->insert('{{%auth_user_group}}',['id'=>'567','name'=>'财务管理','type'=>'1','description'=>'','module_name'=>'diandi_distribution','created_at'=>'1616639209','updated_at'=>'1616639209']);
