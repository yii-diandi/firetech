...
class m200624_051745_menu extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%menu}}',['id'=>'223','name'=>'快速生成','parent'=>NULL,'route'=>NULL,'order'=>'10','data'=>NULL,'type'=>'sysai','icon'=>'','is_sys'=>'system','module_name'=>'']);
        ...
        $this->insert('{{%menu}}',['id'=>'306','name'=>'首页','parent'=>NULL,'route'=>NULL,'order'=>NULL,'data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
        ...
        $this->insert('{{%menu}}',['id'=>'311','name'=>'商品管理','parent'=>'310','route'=>'/diandi_distribution/goods/goods/index','order'=>NULL,'data'=>NULL,'type'=>'plugins','icon'=>'','is_sys'=>'addons','module_name'=>'diandi_distribution']);
