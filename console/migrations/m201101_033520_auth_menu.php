...
class m201101_033520_auth_menu extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 外键约束设置 */
        $this->addForeignKey('fk_menu_5821_00','{{%auth_menu}}', 'parent', '{{%menu}}', 'id', 'CASCADE', 'CASCADE' );
        ...
        $this->insert('{{%auth_menu}}',['id'=>'26','name'=>'AI会员管理','parent'=>NULL,'route'=>'/diandiai/dd-ai-member/index','order'=>NULL,'data'=>NULL,'type'=>'aimember','icon'=>'','is_sys'=>'system','module_name'=>NULL]);
        ...
        $this->insert('{{%auth_menu}}',['id'=>'36','name'=>'应用管理','parent'=>NULL,'route'=>'/diandiai/dd-ai-applications/index','order'=>NULL,'data'=>NULL,'type'=>'aimember','icon'=>'','is_sys'=>'system','module_name'=>NULL]);
        $this->insert('{{%auth_menu}}',['id'=>'37','name'=>'人脸库分组','parent'=>NULL,'route'=>'/diandiai/dd-ai-groups/index','order'=>NULL,'data'=>NULL,'type'=>'aimember','icon'=>'','is_sys'=>'system','module_name'=>NULL]);
        $this->insert('{{%auth_menu}}',['id'=>'38','name'=>'人脸管理','parent'=>NULL,'route'=>'/diandiai/dd-ai-faces/index','order'=>NULL,'data'=>NULL,'type'=>'aimember','icon'=>'','is_sys'=>'system','module_name'=>NULL]);
