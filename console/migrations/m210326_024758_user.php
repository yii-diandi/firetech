...
class m210326_024758_user extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 表数据 */
        $this->insert('{{%user}}',['id'=>'11','username'=>'admin','auth_key'=>'ddkNMK6gRRPa82aYfvTfzmQ0xYHyZT-i','password_hash'=>'$2y$13$A2Syvv6yh7SmMc3TAQSwx.UHQoaNJpTTCuKIFmgOuV3EV6cyHNvSW','password_reset_token'=>'el2dBEBST3tcPdeGSLiYYP9zrOJRjevl_1615106245','email'=>'admin@163.com','store_id'=>'0','bloc_id'=>'0','status'=>'10','created_at'=>'1586678074','updated_at'=>'1586678074','verification_token'=>NULL,'last_time'=>'1615106245','avatar'=>NULL,'is_login'=>'1','last_login_ip'=>'127.0.0.1']);
