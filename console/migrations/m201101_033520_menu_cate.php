...
class m201101_033520_menu_cate extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%menu_cate}}',['id'=>'2','name'=>'权限','mark'=>'auth','sort'=>'2','create_time'=>'1580017890','update_time'=>'1580016673','icon'=>'fa fa-fw fa-eye']);
