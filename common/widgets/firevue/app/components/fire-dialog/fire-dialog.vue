...
<template>
  <div v-show="visible" class="sy-dialog-content" ref="elementdialog">
    <el-card    class="sy-dialog-card" :body-style="{ padding: '0px' }"  v-loading="loading"  element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading">
      ...
      <iframe  :src="url"    @load="getLoding()" frameborder="0" width="100%" :height="iframeH"></iframe>
     </el-card>
  </div>
</template>
